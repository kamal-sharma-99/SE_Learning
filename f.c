...
//	fflush(stdin);
		...
		if(choice == 'N' || choice == 'n'){
			...
			printf("Type CS for Customizing your thali\n\n");
...
//			finish
			...
			printf("Type CS for Customizing your meal\n");	
...
//			hello
			...
			printf("Type CS for Customizing your chinese dish\n");
